...
const TmpClient = require('../src/tmoClient').default;
const WrapClient = require('../src/WrapClient').default;
...
async function renderReactTree(res, props) {
  ...
  const Wrap = React.createElement(WrapClient, React.createElement(TmpClient, {}))

  const App = React.createElement(ReactApp, Wrap)

  // const clientRoot = React.createElement(TmpClient, value)
